...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.5  //-1.3 //-4.1  // Z offset: -below +above  [the nozzle] -0.5 is lower nozzle than -4.1
...
#define MANUAL_Z_HOME_POS 292.1 // Distance between the nozzle to printbed after homing
